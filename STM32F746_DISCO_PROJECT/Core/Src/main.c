...
uint32_t AUDIO_IN_DATA[AUDIO_BUFFER_SIZE];
uint32_t AUDIO_OUT_DATA[AUDIO_BUFFER_SIZE];

WM8994_Object_t wm8994_Obj;
WM8994_Object_t *wm8994_Obj_ptr = &wm8994_Obj;
WM8994_IO_t wm8994_IO;
WM8994_Init_t wm8994_INIT;
WM8994_Init_t *wm8994_Init_ptr = &wm8994_INIT;
...
/* Configure the peripherals common clocks */
  ...
  statusTx = HAL_SAI_Transmit_DMA(&hsai_BlockA2, (uint8_t *)AUDIO_OUT_DATA, AUDIO_BUFFER_SIZE);
  statusRx = HAL_SAI_Receive_DMA(&hsai_BlockB2, (uint8_t *)AUDIO_IN_DATA, AUDIO_BUFFER_SIZE);
